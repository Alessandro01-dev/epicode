...
const readMoreBtnElement = document.querySelector(".read-more-btn");

function createMainArticlesCard(mainArticle) {
...
function getAndAppendIndexNumberOfMainArticles() {
  for (let i = 0; i < mainArticles.length; i++) {
    ...
    createMainArticlesCard(mainArticles[i]);

  }
}
getAndAppendIndexNumberOfMainArticles();

function cleanReadMoreButton() {
  readMoreBtnElement.remove()
}

function displayNoOtherArticlesMessage() {
  const noOtherArticlesMessage = document.createElement("div")
  noOtherArticlesMessage.innerText = "no other articles"
  noOtherArticlesMessage.classList.add("no-other-articles")
  mainArticlesContainerElement.after(noOtherArticlesMessage)
}


readMoreBtnElement.addEventListener("click", () => {
  mainArticlesContainerElement.innerHTML = "";
  increaseIndex()
  getAndAppendIndexNumberOfMainArticles()
